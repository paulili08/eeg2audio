...
if __name__ == "__main__":
    ...
    (sr,wf) = wavefile.read(r'D:\\pycharm\PyCharm Community Edition 2022.3.1\SingleWordProductionDutch-main\SingleWordProductionDutch-main\results\sub-10_orig_synthesized.wav')
    wf = wf[10*sr:20*sr]
